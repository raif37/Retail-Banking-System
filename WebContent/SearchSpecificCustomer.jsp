...
<title>Search Specific Customer</title>
<style type="text/css">
      *{
             font-family: cursive;
       }
...
<center><h1><font color="black"> Search Customer</font> </h1></center>
<br><br><br>
<form action="CustomerServlet" method="post">
			<center><table style="width: 25%">
				...
				<tr>
					...
					<td>
						<input type="text" placeholder="Enter value" name="searchval" required>
					</td>
