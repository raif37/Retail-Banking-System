...
<center><h1><font color="black">Withdraw Amount</font></h1></center>	
<style>
body{
/* color:#4169E1;
...
<br><br><br>
	<form action="TransactionServlet" method="post" name="f1">
		<font color="black">Enter amount: Rs </font><input type="text" name="amount"><font color="black"></font><br><br><br>
